...
function receivePictureFile()
{
  ...
  {
    logToFile( "The file " . basename( $_FILES['uploadedfile']['name']) . " has been uploaded");
  } 
  else
  {
    logToFile("There was an error uploading the file, please try again!");
  }
